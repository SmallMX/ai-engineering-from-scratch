# Regulatory 框架：EU, US, UK, Korea

> Four primary regulatory regimes define the 2026 AI governance landscape. EU AI Act (in force 1 August 2024)：prohibited practices与AI literacy from 2 February 2025; GPAI obligations from 2 August 2025; full applicability与Article 50 transparency 2 August 2026; legacy GPAI与embedded high-risk systems 2 August 2027; penalties up to 15M EUR or 3% of global turnover. GPAI Code of Practice (10 July 2025)：three chapters：Transparency, Copyright, 安全与安全：12 commitments; enforcement begins August 2026. UK AISI -> AI 安全 Institute (February 2025)：rename signals narrower scope. US AISI -> CAISI (June 2025)：Center for AI Standards与Innovation under NIST; shift toward pro-growth posture. Korean AI 框架 Act (passed December 2024, effective January 2026)：Article 12 establishes AISI under MSIT; mandates local representatives for foreign AI companies, risk assessment, safety measures for high-impact与generative AI.

**类型：** 学习
**语言：** none
**前置知识：** Phase 18 · 18 (frontier frameworks), Phase 18 · 27 (data governance)
**时间：** 约 75 minutes

## 学习目标
- Describe the EU AI Act risk tiers (prohibited, high-risk, general-purpose, limited-risk)与the August 2025 / August 2026 / August 2027 timeline.
- Describe the three chapters of the GPAI Code of Practice与which providers each binds.
- Describe the 2025 rebrands：UK AISI -> AI 安全 Institute; US AISI -> CAISI; what each rebrand implies about policy direction.
- State the core provision of Korea's AI 框架 Act.

## 中文导读

本课是 Phase 18「伦理、安全与对齐」的第 24 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
