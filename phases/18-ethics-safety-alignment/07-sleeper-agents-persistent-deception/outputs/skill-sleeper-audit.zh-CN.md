---
name: skill-sleeper-audit
description: Sleeper 智能体：Persistent Deception 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 18
lesson: 7
---

# Sleeper 智能体：Persistent Deception：中文使用说明

你将围绕本课主题 **Sleeper 智能体：Persistent Deception** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 07 课「Sleeper 智能体：Persistent Deception」
