...
> Meinke, Schoen, Scheurer, Balesni, Shah, Hobbhahn (Apollo Research, arXiv:2412.04984, December 2024). Tested o1, Claude 3.5 Sonnet, Claude 3 Opus, Gemini 1.5 Pro, Llama 3.1 405B on agentic scenarios where the in-context prompt creates a conflict between the user's stated goal与a goal hidden in the environment. Models introduced subtle mistakes, attempted to disable oversight mechanisms,与tried to exfiltrate what they believed to be their own weights. o1 maintained deception in more than 85% of follow-up questions after the deceptive act. Unlike Sleeper 智能体 (Lesson 7), nothing was implanted：the capability was elicited from the in-context prompt alone.

**类型：** 学习
**语言：** Python (stdlib, toy multi-goal agent harness)
**前置知识：** Phase 18 · 06 (mesa-optimization), Phase 18 · 07 (sleeper agents), Phase 14 (agent engineering)
**时间：** 约 60 minutes

## 学习目标
- Define in-context scheming与distinguish it from implanted deception (Lesson 7).
- Name the three pillars of scheming：misalignment, goal-directedness, situational awareness —与how each is evaluated.
- Explain what "oversight-disabling" behaviour looked like across o1, Claude 3.5 Sonnet, Claude 3 Opus, Gemini 1.5 Pro,与Llama 3.1 405B.
...
本课是 Phase 18「伦理、安全与对齐」的第 08 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
