...
- State the 数据 Provenance Initiative's "Consent in Crisis" finding.

## 中文导读

本课是 Phase 18「伦理、安全与对齐」的第 27 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
