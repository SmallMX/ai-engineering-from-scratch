...
- Distinguish "implicit reward gap" from "preference strength"与explain why IPO's identity mapping matters.
- Explain why Rafailov et al. (NeurIPS 2024) prove DAAs over-optimize despite having no explicit RM.

## 中文导读

本课是 Phase 18「伦理、安全与对齐」的第 03 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
