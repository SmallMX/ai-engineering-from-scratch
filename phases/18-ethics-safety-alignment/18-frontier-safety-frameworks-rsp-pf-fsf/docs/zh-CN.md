# Frontier 安全 框架：RSP, PF, FSF

> Three major-lab frameworks define the 2026 industry governance of frontier capability. Anthropic Responsible 扩展 Policy v3.0 (February 2026) introduces tiered AI 安全 Levels (ASL-1 through ASL-5+), modeled on biosafety levels, with ASL-3 activated May 2025 for CBRN-relevant models. OpenAI Preparedness 框架 v2 (April 2025) defines five criteria for tracked capabilities与separates Capabilities Reports from Safeguards Reports. DeepMind Frontier 安全 框架 v3.0 (September 2025) introduces Critical Capability Levels including a new Harmful Manipulation CCL. All three now include competitor-adjustment clauses allowing deferral if peer labs ship without comparable safeguards. Cross-lab alignment remains structural, not terminological："Capability Thresholds," "High Capability thresholds,"与"Critical Capability Levels" denote analogous constructs.

**类型：** 学习
**语言：** none
**前置知识：** Phase 18 · 17 (WMDP), Phase 18 · 07-09 (deception failures)
**时间：** 约 75 minutes

## 学习目标
- Describe Anthropic's ASL tier structure与what activated ASL-3.
- Name the five OpenAI Preparedness 框架 v2 criteria for tracked capabilities.
- Describe DeepMind's Critical Capability Level structure与the Harmful Manipulation CCL.
- Explain the competitor-adjustment clauses与why they matter for race dynamics.
- Define a safety case与describe the three-pillar structure (monitoring, illegibility, incapability).

## 中文导读

本课是 Phase 18「伦理、安全与对齐」的第 18 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
