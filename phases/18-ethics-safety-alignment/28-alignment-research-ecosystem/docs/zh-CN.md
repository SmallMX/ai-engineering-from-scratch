...
> Five organisations define the 2026 non-lab alignment research layer. MATS (ML 对齐与Theory Scholars)：527+ researchers since late 2021, 180+ papers, 10K+ citations, h-index 47; summer 2024 cohort incorporated as 501(c)(3) with ~90 scholars与40 mentors; 80% of pre-2025 alumni work on safety/security with 200+ at Anthropic, DeepMind, OpenAI, UK AISI, RAND, Redwood, METR, Apollo. Redwood Research：applied alignment lab founded by Buck Shlegeris; introduced AI Control (Lesson 10); collaborates with UK AISI on control safety cases. Apollo Research：pre-deployment scheming evaluations for frontier labs; authored In-Context Scheming (Lesson 8)与Towards 安全 Cases for AI Scheming. METR (Model 评估与Threat Research)：task-based capability evaluations, autonomous-task time-horizon studies; "Common Elements of Frontier AI 安全 Policies" compares lab frameworks. Eleos AI Research：model-welfare pre-deployment evaluations (Lesson 19); conducted Claude Opus 4 welfare assessment.

**类型：** 学习
**语言：** none
**前置知识：** Phase 18 · 01-27 (prior Phase 18 lessons)
**时间：** 约 45 minutes

## 学习目标
- Identify the five organisations of the non-lab alignment research ecosystem与their core output.
- Describe MATS's scale (scholars, papers, h-index)与its role as a talent pipeline.
- Describe Redwood's AI Control agenda与its partnership with UK AISI.
- Describe METR's task-based evaluation methodology.

## 中文导读

本课是 Phase 18「伦理、安全与对齐」的第 28 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
