---
name: skill-asr-configurator
description: 音频 Transformer：Whisper Architecture 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 7
lesson: 10
---

# 音频 Transformer：Whisper Architecture：中文使用说明

你将围绕本课主题 **音频 Transformer：Whisper Architecture** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 10 课「音频 Transformer：Whisper Architecture」
