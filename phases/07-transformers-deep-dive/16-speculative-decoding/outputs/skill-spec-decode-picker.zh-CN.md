---
name: skill-spec-decode-picker
description: Speculative Decoding：Draft, Verify, Repeat 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 7
lesson: 16
---

# Speculative Decoding：Draft, Verify, Repeat：中文使用说明

你将围绕本课主题 **Speculative Decoding：Draft, Verify, Repeat** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 16 课「Speculative Decoding：Draft, Verify, Repeat」
