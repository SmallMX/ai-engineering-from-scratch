...
description: RLHF：奖励 Model + PPO 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 10
lesson: 7
---

# RLHF：奖励 Model + PPO：中文使用说明

你将围绕本课主题 **RLHF：奖励 Model + PPO** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
