...
description: 数据 Pipelines for Pre-训练 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 10
lesson: 3
---

# 数据 Pipelines for Pre-训练：中文使用说明

你将围绕本课主题 **数据 Pipelines for Pre-训练** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 03 课「数据 Pipelines for Pre-训练」
