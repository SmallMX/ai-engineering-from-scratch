---
name: skill-vllm-stack-decider
description: vLLM 生产 Stack with LMCache KV Offloading 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 17
lesson: 18
---

# vLLM 生产 Stack with LMCache KV Offloading：中文使用说明

你将围绕本课主题 **vLLM 生产 Stack with LMCache KV Offloading** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 18 课「vLLM 生产 Stack with LMCache KV Offloading」
