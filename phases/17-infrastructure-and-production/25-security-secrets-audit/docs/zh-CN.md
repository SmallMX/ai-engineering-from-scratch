...
## 学习目标
- Enumerate the four secret-management anti-patterns (config files in VCS, hardcoded env, spreadsheets, static keys)与name their replacements.
...
- Name the 2026 Vercel supply-chain incident与what it taught about CI/CD credential hygiene.

## 中文导读

本课是 Phase 17「基础设施与生产部署」的第 25 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
