---
name: skill-compliance-matrix
description: 合规：SOC 2, HIPAA, GDPR, PCI-DSS, EU AI Act, ISO 42001 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 17
lesson: 26
---

# 合规：SOC 2, HIPAA, GDPR, PCI-DSS, EU AI Act, ISO 42001：中文使用说明

你将围绕本课主题 **合规：SOC 2, HIPAA, GDPR, PCI-DSS, EU AI Act, ISO 42001** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 26 课「合规：SOC 2, HIPAA, GDPR, PCI-DSS, EU AI Act, ISO 42001」
