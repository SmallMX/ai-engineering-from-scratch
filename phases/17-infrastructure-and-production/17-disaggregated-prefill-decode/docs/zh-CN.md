...
- Distinguish NVIDIA Dynamo (stack-above) from llm-d (Kubernetes-native)与match each to an operational context.

## 中文导读

本课是 Phase 17「基础设施与生产部署」的第 17 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
