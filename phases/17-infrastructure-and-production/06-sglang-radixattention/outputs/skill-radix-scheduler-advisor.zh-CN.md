---
name: skill-radix-scheduler-advisor
description: SGLang与RadixAttention for Prefix-Heavy Workloads 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 17
lesson: 6
---

# SGLang与RadixAttention for Prefix-Heavy Workloads：中文使用说明

你将围绕本课主题 **SGLang与RadixAttention for Prefix-Heavy Workloads** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 06 课「SGLang与RadixAttention for Prefix-Heavy Workloads」
