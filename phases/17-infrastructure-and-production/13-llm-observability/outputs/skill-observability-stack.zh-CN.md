---
name: skill-observability-stack
description: LLM 可观测性 Stack Selection 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 17
lesson: 13
---

# LLM 可观测性 Stack Selection：中文使用说明

你将围绕本课主题 **LLM 可观测性 Stack Selection** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 13 课「LLM 可观测性 Stack Selection」
