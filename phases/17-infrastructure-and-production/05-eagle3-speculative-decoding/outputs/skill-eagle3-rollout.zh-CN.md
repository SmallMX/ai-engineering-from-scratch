---
name: skill-eagle3-rollout
description: EAGLE-3 Speculative Decoding in 生产 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 17
lesson: 5
---

# EAGLE-3 Speculative Decoding in 生产：中文使用说明

你将围绕本课主题 **EAGLE-3 Speculative Decoding in 生产** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 05 课「EAGLE-3 Speculative Decoding in 生产」
