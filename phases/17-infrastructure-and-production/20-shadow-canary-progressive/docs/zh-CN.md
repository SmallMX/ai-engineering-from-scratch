# Shadow Traffic, Canary Rollout,与Progressive Deployment for LLM
...
**前置知识：** Phase 17 · 13 (可观测性), Phase 17 · 21 (A/B Testing)
**时间：** 约 60 minutes

## 学习目标
- Distinguish shadow mode (zero-impact compare), canary (live traffic progressive),与A/B (stability-confirmed comparison).
...
本课是 Phase 17「基础设施与生产部署」的第 20 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
