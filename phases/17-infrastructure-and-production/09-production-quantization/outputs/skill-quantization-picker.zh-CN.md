---
name: skill-quantization-picker
description: 生产 量化：AWQ, GPTQ, GGUF K-quants, FP8, MXFP4/NVFP4 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 17
lesson: 9
---

# 生产 量化：AWQ, GPTQ, GGUF K-quants, FP8, MXFP4/NVFP4：中文使用说明

你将围绕本课主题 **生产 量化：AWQ, GPTQ, GGUF K-quants, FP8, MXFP4/NVFP4** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 课程：第 09 课「生产 量化：AWQ, GPTQ, GGUF K-quants, FP8, MXFP4/NVFP4」
