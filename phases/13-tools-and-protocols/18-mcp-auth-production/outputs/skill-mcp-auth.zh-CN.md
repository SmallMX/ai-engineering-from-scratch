---
name: skill-mcp-auth
description: MCP Auth in 生产：Enrollment, JWKS Refresh, Audience-Pinned Tokens 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 13
lesson: 18
---

# MCP Auth in 生产：Enrollment, JWKS Refresh, Audience-Pinned Tokens：中文使用说明

你将围绕本课主题 **MCP Auth in 生产：Enrollment, JWKS Refresh, Audience-Pinned Tokens** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 13「工具与协议」
- 课程：第 18 课「MCP Auth in 生产：Enrollment, JWKS Refresh, Audience-Pinned Tokens」
