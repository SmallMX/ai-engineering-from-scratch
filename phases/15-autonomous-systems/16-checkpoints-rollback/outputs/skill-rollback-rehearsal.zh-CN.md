---
name: skill-rollback-rehearsal
description: Checkpoints与Rollback 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 15
lesson: 16
---

# Checkpoints与Rollback：中文使用说明

你将围绕本课主题 **Checkpoints与Rollback** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 15「自主系统」
- 课程：第 16 课「Checkpoints与Rollback」
