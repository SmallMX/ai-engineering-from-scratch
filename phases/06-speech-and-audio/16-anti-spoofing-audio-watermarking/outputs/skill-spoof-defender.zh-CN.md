---
name: skill-spoof-defender
description: 语音 Anti-Spoofing与音频 水印：ASVspoof 5, AudioSeal, WaveVerify 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 6
lesson: 16
---

# 语音 Anti-Spoofing与音频 水印：ASVspoof 5, AudioSeal, WaveVerify：中文使用说明

你将围绕本课主题 **语音 Anti-Spoofing与音频 水印：ASVspoof 5, AudioSeal, WaveVerify** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 6「语音与音频」
- 课程：第 16 课「语音 Anti-Spoofing与音频 水印：ASVspoof 5, AudioSeal, WaveVerify」
