---
name: skill-feature-extractor
description: 声谱图, Mel Scale与音频 Features 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 6
lesson: 2
---

# 声谱图, Mel Scale与音频 Features：中文使用说明

你将围绕本课主题 **声谱图, Mel Scale与音频 Features** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 6「语音与音频」
- 课程：第 02 课「声谱图, Mel Scale与音频 Features」
