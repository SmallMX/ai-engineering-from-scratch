...
## 学习目标
- Generate text embeddings using API providers与open-source models,与compute cosine similarity between them
...
- Evaluate embedding quality using retrieval benchmarks (precision@k, recall)与choose the right embedding model for your task

## 中文导读

本课是 Phase 11「LLM 工程」的第 04 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
