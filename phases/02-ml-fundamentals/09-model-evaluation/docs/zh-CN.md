...
1. 评估指标必须匹配任务和业务成本。
2. classification 常用 accuracy、precision、recall、F1、ROC-AUC 和 PR-AUC。
3. regression 常用 MAE、MSE、RMSE 和 R²。
4. confusion matrix 能展示具体错分类型。
5. 交叉验证、校准和置信区间帮助判断模型表现是否稳定。
