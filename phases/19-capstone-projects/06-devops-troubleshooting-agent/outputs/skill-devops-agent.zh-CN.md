---
name: skill-devops-agent
description: 毕业项目 06：DevOps Troubleshooting 智能体 for Kubernetes 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 19
lesson: 6
---

# 毕业项目 06：DevOps Troubleshooting 智能体 for Kubernetes：中文使用说明

你将围绕本课主题 **毕业项目 06：DevOps Troubleshooting 智能体 for Kubernetes** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 19「毕业项目」
- 课程：第 06 课「毕业项目 06：DevOps Troubleshooting 智能体 for Kubernetes」
