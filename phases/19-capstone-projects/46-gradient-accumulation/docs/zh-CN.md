...
> Train at an effective batch you cannot afford, one micro-batch at a time. Scale the loss, hold the optimizer step,与let the gradients pile up.
...
- Read a throughput against effective batch curve与explain the diminishing return.

## 中文导读

本课是 Phase 19「毕业项目」的第 46 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
