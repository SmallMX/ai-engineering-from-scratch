...
- Run the loop to a self-terminating end与emit a single demo report that lists every stage's output.
...
本课是 Phase 19「毕业项目」的第 57 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
