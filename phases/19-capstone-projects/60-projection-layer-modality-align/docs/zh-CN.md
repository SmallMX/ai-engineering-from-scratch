...
- Compute a cosine alignment loss between projected image tokens与a paired caption embedding.
- Train the projection alone with a frozen vision encoder与a frozen text table.

## 中文导读

本课是 Phase 19「毕业项目」的第 60 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
