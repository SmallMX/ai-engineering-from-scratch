...
## 学习目标
- Represent a plan as an ordered list of typed steps so the executor can reason about progress与outcome.
...
- Enforce two budgets：a hard step ceiling与a hard replan ceiling.

## 中文导读

本课是 Phase 19「毕业项目」的第 24 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
