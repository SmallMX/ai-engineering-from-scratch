...
> Translation is the task that paid for NLP research for thirty years与keeps paying now.

**类型：** 构建
**语言：** Python
**前置知识：** Phase 5 · 10 (注意力 Mechanism), Phase 5 · 04 (GloVe, FastText, Subword)
**时间：** 约 75 minutes
...
本课是 Phase 5「NLP：从基础到进阶」的第 11 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
