...
> Three systems shaped modern QA. Extractive found spans. 检索-augmented grounded them in documents. Generative produced answers. Every modern AI assistant is a mix of the three.

**类型：** 构建
**语言：** Python
**前置知识：** Phase 5 · 11 (机器翻译), Phase 5 · 10 (注意力 Mechanism)
**时间：** 约 75 minutes
...
本课是 Phase 5「NLP：从基础到进阶」的第 13 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
