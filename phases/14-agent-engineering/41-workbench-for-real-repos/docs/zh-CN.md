...
**类型：** 构建
**语言：** Python (stdlib)
**前置知识：** Phases 14 · 32 to 14 · 40
**时间：** 约 60 minutes

## 学习目标
- Bring the seven workbench surfaces together on a small application.
- Run the same task twice (prompt-only与workbench-guided)与measure five outcomes.
- Read the before/after report与decide which surfaces gave the most leverage.
- Defend the workbench against a "but my model is good enough" pushback.

## 中文导读

本课是 Phase 14「智能体工程」的第 41 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
