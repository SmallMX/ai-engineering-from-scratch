---
name: skill-minimal-workbench
description: The Minimal 智能体 Workbench 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 14
lesson: 32
---

# The Minimal 智能体 Workbench：中文使用说明

你将围绕本课主题 **The Minimal 智能体 Workbench** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 14「智能体工程」
- 课程：第 32 课「The Minimal 智能体 Workbench」
