# 智能体 Instructions as Executable Constraints

> Instructions written as prose are wishes. Instructions written as constraints are tests. The workbench turns each rule into something an agent can check at runtime与a reviewer can verify after the fact.
...
- Express startup rules, forbidden actions, definition of done, uncertainty handling,与approval boundaries as machine-checkable constraints.
...
本课是 Phase 14「智能体工程」的第 33 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
