# 智能体 可观测性：Langfuse, Phoenix, Opik
...
## 学习目标
- Name the three top open-source agent observability platforms与their licenses.
...
本课是 Phase 14「智能体工程」的第 24 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
