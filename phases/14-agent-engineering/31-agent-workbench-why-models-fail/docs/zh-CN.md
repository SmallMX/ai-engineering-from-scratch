# 智能体 Workbench 工程：Why Capable Models Still Fail

> A capable model is not enough. Reliable agents need a workbench：instructions, state, scope, feedback, verification, review,与handoff. Strip those away与even a frontier model produces work that is unsafe to ship.

**类型：** Learn + Build
**语言：** Python (stdlib)
**前置知识：** Phase 14 · 01 (智能体 Loop), Phase 14 · 26 (Failure Modes)
**时间：** 约 45 minutes
...
本课是 Phase 14「智能体工程」的第 31 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
