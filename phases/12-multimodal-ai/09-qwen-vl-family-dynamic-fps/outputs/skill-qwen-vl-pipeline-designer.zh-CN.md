---
name: skill-qwen-vl-pipeline-designer
description: Qwen-VL Family与Dynamic-FPS 视频 的中文辅助说明，用于学习、复盘和复用本课产物
version: 1.0.0
phase: 12
lesson: 9
---

# Qwen-VL Family与Dynamic-FPS 视频：中文使用说明

你将围绕本课主题 **Qwen-VL Family与Dynamic-FPS 视频** 使用这个课程产物。它可以作为 prompt、skill、检查清单或实现参考。
...
- 阶段：Phase 12「多模态 AI」
- 课程：第 09 课「Qwen-VL Family与Dynamic-FPS 视频」
