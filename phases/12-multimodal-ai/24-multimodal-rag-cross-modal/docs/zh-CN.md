# 多模态 RAG与Cross-Modal 检索

> 视觉-native document RAG is one slice. 生产 multimodal RAG goes wider：retrieving across text, images, audio,与video for workflows like trip planning ("find me a quiet vegan brunch with natural light"), medical triage ("what injury matches this photo + these notes"), e-commerce ("outfits similar to this selfie, in my size"),与field service ("diagnose this engine sound plus photo of the part"). Three 2025 surveys：Abootorabi et al., Mei et al., Zhao et al.：codified the sub-problems：cross-modal retrieval, retrieval fusion, generation grounding, multimodal evaluation. This lesson reads the surveys与designs a production pipeline.
...
- Name the three canonical multimodal RAG surveys of 2025与their sub-problem taxonomy.

## 中文导读

本课是 Phase 12「多模态 AI」的第 24 课。学习时建议先读这一份中文导读，确认本课要解决的问题、关键术语和可运行产物，再回到英文原文核对细节。
